...
// Helper functions
inline void a429_set(a429_word_ptr_t word, const char* octal_number, a429_sdi_t sdi, uint32_t bnr_value) {
  word[0] = 0;
  a429_label_set(word, a429_label_encode(octal_number));
  a429_sdi_set(word, sdi);
  a429_bnr_set(word, bnr_value);
}

inline void a429_set(a429_word_ptr_t word, a429_label_number_t encoded_number, a429_sdi_t sdi, uint32_t bnr_value) {
  word[0] = 0;
  a429_label_set(word, encoded_number);
  a429_sdi_set(word, sdi);
  a429_bnr_set(word, bnr_value);
}
